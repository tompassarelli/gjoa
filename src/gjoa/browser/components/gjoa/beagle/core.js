// VENDORED from ~/code/beagle/beagle-lib/lib/beagle/core.js — the $$bc value-
// semantics runtime. Firefox chrome ES loader cannot resolve the bare `beagle/`
// specifier beagle emits, so we ship beagle/ here under resource:///modules/gjoa/
// and set BEAGLE_JS_RUNTIME_PREFIX=resource:///modules/gjoa/beagle/ (tools/prep/
// overlay.bjs). Original filename kept so a future beagle/hamt.js (which imports
// ./core.js) resolves as a sibling. DO NOT hand-edit; re-vendor from beagle.
